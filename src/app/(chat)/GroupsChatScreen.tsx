    ...
    return (
        <GestureScreenContainer>
            <ScrollView className="w-full h-full mt-4" >
                ...
                <PrivateChatCard onPressEvent={Alert.alert("Info", "Where block")} userName="Blaze" message="Olá" dateSent="13:20" isCurrentUserThatSentThisMessage={false} />
                ...
                <PrivateChatCard userName="joana 123" message="Text" dateSent="19:01" isCurrentUserThatSentThisMessage={false} messageStatus={MessageStatus.SENT} messageType={MessageTypes.RECORDED_AUDIO} />
