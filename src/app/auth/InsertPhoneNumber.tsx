...
export default function InsertPhoneNumber (): ReactElement {
  ...
  return (
    <ScreenContainer>
      ...
      <ModalLoading visible={isLoadingVisible} text="Conectando" />
      <StatusBar />
    </ScreenContainer>
  );
}

function nextStepAlert (navigation: any, phoneNumber: string): void {
  Alert.alert("Confirmação!", `Você confirma que ${ phoneNumber } realmente é o seu número?`, [
    ...
    },
    {
      ...
      onPress: async (): Promise<void> => {
        ...
        navigation.navigate(`${ Screens.AUTH.VALIDATE_OTP_CODE }`);
      }
    }
  ])
}
