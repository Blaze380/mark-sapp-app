...
export default function LinkButton (props: Props): ReactElement {
  ...
  return (
    <TouchableOpacity className="items-center justify-center w-[300] h-11 rounded-full" lightColor={Colors.light.buttonBackground} darkColor={Colors.dark.buttonBackground} onPress={(): void => router.push(props.href as any)}>
