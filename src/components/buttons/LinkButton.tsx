...
export default function LinkButton (props:Props): ReactElement {
  ...
  useEffect((): void => {
    ...
    return (
      <TouchableOpacity style={Styles.button} lightColor={Colors.light.buttonBackground} darkColor={Colors.dark.buttonBackground} onPress={():void=>navigation.navigate(props.href)}>
